        ...
        dbc.Row([
            dbc.Col([
                ...
                dbc.Row([
                    ...
                    dbc.Button("Try Out Dashboard", href="/zotero", color="dark", outline=True)
                    ])
            ]),
        ...
        dbc.Row([
            dbc.Col([
                ...
                dbc.Row([
                    ...
                    dbc.Button("Explore the API", href="/swagger", color="dark", outline=True) # This is a really akwared way of doing port routing...
                    ])
            ]),
