        ...
        dbc.Row([
            dbc.Col([
                ...
                dbc.Row([
                    ...
                    dbc.Button("Try Out Dashboard", href="http://www.matthewteelucksingh.me/zotero/", color="dark", outline=True)
                    ])
            ]),
        ...
        dbc.Row([
            dbc.Col([
                ...
                dbc.Row([
                    ...
                    dbc.Button("Explore the API", href="http://www.matthewteelucksingh.me/", color="dark", outline=True) # This is a really akwared way of doing port routing...
                    ])
            ]),
    ...
    blog_CRUD_project = html.Div([
        dbc.Row([
            dbc.Col([
                ...
                dbc.Row([
                    html.P("The blog API is powered by my DRF API project. The API provides all the back-end CRUD functionality and the front-end that displays each blog post and allows me to create posts and make edits is built in Flask using Jinja2 templates and the TinyMCE editor.", className="lead"), 
                    dbc.Button("Read Blog", href="http://www.matthewteelucksingh.me:81/", color="dark", outline=True)
                    ])
            ]),
